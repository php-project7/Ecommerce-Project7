        ...
        <div class="header-top">
            <div class="container">
                <div class="header-left">
                    <a href="tel:#"><i class="icon-phone"></i>Call Us:
                        +962770245060</a>
                </div>
                <!-- End .header-left -->
                ...
                <div class="header-right py-3">
                    <ul class="top-menu">
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="#signin-modal" data-toggle="modal">Sign
                                        in / Sign up</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            ...
                            <?php if ($_SESSION['id'] != 0) { ?>
                                <li>
                                    <a href="pages/dashboard.php" class="  ">MY
                                        ACCOUNT</a>
            ...
            <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light"
              ...
              ">
                    <div class="container intro-content">
                        <div class="row justify-content-end">
                            <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                                <h3 class="intro-subtitle text-primary">New
                                    Arrival</h3>
                                <!-- End .h3 intro-subtitle -->
                        ...
                        <?php foreach ($result as $row) { ?>
                            <div class='product product-2'>
                                <figure class='product-media'>
                                    ...
                                    <div class='product-action'><?php if ($row['stock']) { ?>
                                            <a
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="icon-box icon-box-side">
                                    ...
                                    <div class="icon-box-content">
                                        <h3 class="icon-box-title">Get 20% Off 1
                                            Item</h3>
                                        <!-- End .icon-box-title -->
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-10 col-md-8 col-lg-6">
                        <div class="cta-heading text-center">
                            <h3 class="cta-title text-white">Get The Latest
                                Deals</h3>
                            <!-- End .cta-title -->
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="#signin-modal" data-toggle="modal">Sign
                                        Up</a></li>
                            </ul>
                            <!-- End .widget-list -->
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="pages/wishlist.html">My
                                        Wishlist</a></li>
                            </ul>
                            <!-- End .widget-list -->
                        </div>
...
<div class="mobile-menu-container mobile-menu-light">
    <div class="mobile-menu-wrapper">
        ...
        <ul class="nav nav-pills-mobile nav-border-anim" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="mobile-menu-link"
                   data-toggle="tab" href="#mobile-menu-tab"
                   role="tab" aria-controls="mobile-menu-tab"
        ...
        <div class="social-icons">
            <a href="https://web.facebook.com/" class="social-icon"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="signin-2"
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                                    ...
                                    <div class="form-group">
                                        <label for="singin-password-2">Password
                                            *</label>
                                        <input type="password"
                                               class="form-control"
                                    ...
                                    <div class="form-footer">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="signin-remember-2">Remember
                                                Me</label>
                            ...
                            <div class="tab-pane fade show active"
                                 id="register-2" role="tabpanel"
                                 aria-labelledby="register-tab-2">
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                                      method="post">
                                    <?php include('admin/config/errors.php'); ?>
                                    <div class="form-group">
                                        <label for="register-email-2">Your Name
                                            *</label>
                                        <input type="text" class="form-control"
                                               id="register-email-2" name="name"
                                               value="<?php echo $name; ?>"
                                               required>
                                    </div>
                                    <div class="form-group">
                                        <label for="register-email-2">Your email
                                            address *</label>
                                    ...
                                    <div class="form-group">
                                        <label for="register-password-2">Password
                                            *</label>
                                        <input type="password"
                                               class="form-control"
                                    ...
                                    <div class="form-group">
                                        <label for="register-password-2">Confirm
                                            Password *</label>
                                        <input type="password"
                                               class="form-control"
                                               id="register-password-2"
