  ...
  <div class="page-wrapper">
      ...
      <div class="header-top">
        <div class="container">
          <div class="header-left">
            <a href="tel:#"><i class="icon-phone"></i>Call Us: +962770245060</a>
          </div>
          <!-- End .header-left -->
                        ...
                        <div class="menu-col">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <ul>
                                <li>
                                  <a href="pages/category-list.php">Shop List</a>
                                </li>
                                <li>
    ...
    <main class="main">
      ...
      <!-- <h3 class="banner-title">
                    <a href="#"
                      >Save $150
                      <strong>on Samsung <br />Galaxy Note9</strong></a
                    >
                  </h3> -->
      <!-- End .banner-title -->
      ...
      <div class="container new-arrivals">
        ...
        <div class="tab-content tab-content-carousel just-action-icons-sm">
          ...
          <!-- <a href="pages/product.html" class="btn btn-link"
          ...
          <!-- <div class="deal-bottom">
                  <div
                    class="deal-countdown offer-countdown"
                    data-until="+11d"
                  ></div> -->
          <!-- End .deal-countdown -->
          <!-- </div> -->
          ...
          <div class="heading heading-flex mb-3">
            ...
            <div class="row justify-content-center">
              ...
              <!-- <h3 class="product-title">
                      <a href="pages/product.html"
                        >Beats by Dr. Dre Wireless Headphones</a
                      >
                    </h3> -->
              <!-- End .product-title -->
              <!-- <div class="product-price">
              ...
              <!-- End .product-cat -->
              <!-- <h3 class="product-title">
                      <a href="pages/product.html">Lenovo - 330-15IKBR 15.6"</a>
                    </h3> -->
              <!-- End .product-title -->
              <!-- <div class="product-price">
              ...
              <!-- <h3 class="product-title">
                      <a href="pages/product.html"
                        >Sony - Alpha a5100 Mirrorless Camera</a
                      >
                    </h3> -->
              <!-- End .product-title -->
              ...
              <!-- <h3 class="product-title">
                      <a href="pages/product.html"
                        >WONDERBOOM Portable Bluetooth Speaker</a
                      >
                    </h3> -->
              <!-- End .product-title -->
              <!-- <div class="product-price">
