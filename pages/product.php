  ...
  <div class="container">
   ...
   <div class="product-details-tab">
    <ul class="nav nav-pills justify-content-center" role="tablist">
     <li class="nav-item">
      <a class="nav-link active" id="product-review-link" data-toggle="tab" href="#product-review-tab" role="tab" aria-controls="product-review-tab" aria-selected="false">Reviews (<?= count($reviews) ?>)</a>
     </li>
     <li class="nav-item">
 ...
 <div class="container">
  <div class="row">
   <div class="col-6">
    ...
    <h4 class="product-title"><a href="product.php"><?= $product["name"] ?></a></h4><!-- End .product-title -->
   </div><!-- End .col-6 -->
